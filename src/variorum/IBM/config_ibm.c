...
int set_ibm_func_ptrs(int idx)
{
    ...
    if (*g_platform[idx].arch_id == POWER9)
    {
        ...
        g_platform[idx].variorum_set_best_effort_node_power_limit =
            p9_set_node_power_limit;
        g_platform[idx].variorum_set_each_socket_power_limit =
            p9_set_socket_power_limit;
        g_platform[idx].variorum_set_gpu_power_ratio = p9_set_gpu_power_ratio;
        g_platform[idx].variorum_set_and_verify_node_power_limit =
